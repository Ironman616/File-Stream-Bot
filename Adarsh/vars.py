...
class Var(object):
    ...
    PICS = (environ.get('PICS','https://graph.org/file/089932133f512c3e7187b.jpg')).split()
    ...
    if HAS_SSL:
        URL = "https://46.4.113.153:9005/".format(FQDN)
    else:
        URL = "hhttps://46.4.113.153:9005/".format(FQDN)
